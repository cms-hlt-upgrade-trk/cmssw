...
namespace phase1PixelTopology {
  ...
  HOST_DEVICE_CONSTANT int16_t phicuts[nPairs]{phi0p05, phi0p07, phi0p07,
...
namespace phase2PixelTopology {
  ...
  HOST_DEVICE_CONSTANT float minz[nPairs] = {
      ...
      23.0,   30.0,   39.0, 50.0, 65.0, 82.0,  109.0, 
      -28.0, -35.0, -44.0, -55.0, -70.0, -87.0, -113.0, 
      -16.,   7.0,    -22.0,  11.0,   -22.0,
      -17.0, 9.0,   -22.0, 13.0,  -22.0, 
      
      137.0, 173.0, 199.0, 229.0,  
      -142.0, -177.0, -203.0, -233.0, 
  ...
  HOST_DEVICE_CONSTANT float maxz[nPairs] = {
      ...
      17.0,   22.0,   -7.0,   22.0,   -10.0,
      17.0, 22.0,  -9.0,  22.0,  -13.0, 
  ...
  HOST_DEVICE_CONSTANT float maxr[nPairs] = {5.0, 5.0, 5.0, 
                                             7.0, 8.0, 8.0,  
                                             7.0, 7.0, 7.0, 
                                             
                                             6.0, 6.0, 6.0, 6.0, 5.0, 6.0, 5.0, 
                                             6.0, 6.0, 6.0, 6.0, 5.0, 6.0, 5.0, 
