...
##### Validation
###
from SimGeneral.TrackingAnalysis.simHitTPAssociation_cfi import simHitTPAssocProducer as _simHitTPAssociation

simHitTPAssociation = _simHitTPAssociation.clone()
...
trackValidatorGeneralTrackingOnly.beamSpot = cms.InputTag("hltOnlineBeamSpot")
...
trackValidatorPixelTrackingOnly.label = cms.VInputTag("pixelTracks")#,"pixelTracksQuads","pixelTracksClean")
...
from DQMOffline.Configuration.DQMOfflineMC_cff import dqmInfoTracking, TrackSeedMoninitialStep, TrackSeedMonhighPtTripletStep
...
from DQM.TrackingMonitor.TrackingMonitor_cfi import TrackMon
from DQM.TrackingMonitor.TrackingMonitorSeed_cfi import TrackMonSeed

DQMStore = cms.Service("DQMStore")


TrackMonintor = TrackMonSeed.clone(
    allTrackProducer = "generalTrackss",
    TrackProducer    = "initialStepTrackss",
    SeedProducer     = "initialStepSeedss",
    TCProducer       = "initialStepTrackCandidatesss",
    MVAProducers     = [""],
    ...
    BSFolderName     = cms.string('TrackingInitial/ParametersVsBeamSpot'),
    PVFolderName     = cms.string('TrackingInitial/PrimaryVertices'),
    numCut           = cms.string(" pt >= 1 ")
)
